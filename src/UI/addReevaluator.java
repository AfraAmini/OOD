...
public class addReevaluator {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					addReevaluator window = new addReevaluator();
	...
	private void createComponents() {
		...
		addEvalFrame.setTitle("انتخاب ارزیابان برای ارزیابی مجدد");
		addEvalFrame.setBounds(100, 100, 545, 196);
		addEvalFrame.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
		
		btnAdd = new JButton("افزودن کارمند به ارزیابان مجدد");
