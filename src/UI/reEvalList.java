...
public class reEvalList {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					reEvalList window = new reEvalList();
	...
	private void createComponents() {
		...
		String[] columnNames = {"ماهیت معیار",
                " نام کارمند", "نام ارزیابان مجدد"};

		Object[][] data = {
		{"نظم کاری", "افرا امینی",
		"یگانه علی‌محمدی، پری‌شاد بهنام قادر", new Integer(5), new Boolean(false)},
		{"تجربه", "پری‌شاد بهنام قادر",
		"افرا امینی، یگانه‌ علی‌محمدی", new Integer(3), new Boolean(true)},
