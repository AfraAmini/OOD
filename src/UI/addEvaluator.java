...
public class addEvaluator {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					addEvaluator window = new addEvaluator();
	...
	private void createComponents() {
		...
		addEvalFrame.setTitle("نمایش لیست ارزیابان");
		...
		JButton button = new JButton("انتخاب ارزیاب از لیست کارمندان");
		button.setForeground(new Color(153, 51, 255));
			...
			groupLayout.createParallelGroup(Alignment.LEADING)
				.addGroup(groupLayout.createSequentialGroup()
					...
					.addGroup(groupLayout.createParallelGroup(Alignment.LEADING)
						.addGroup(groupLayout.createSequentialGroup()
							.addComponent(button, GroupLayout.PREFERRED_SIZE, 182, GroupLayout.PREFERRED_SIZE)
